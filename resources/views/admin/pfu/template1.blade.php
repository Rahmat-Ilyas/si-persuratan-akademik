                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            $notif1 = $get->where('status', 'Dalam Proses')->where('proses', '=', 5)->get();
                            $count1 = count($notif1);
                            @endphp
                        ...
                        <li class="has_sub">
                            <a href="javascript:;" class="waves-effect">
                                <i class="fa fa-files-o"></i><span class="menu-arrow"></span><span>Data Surat</span>
                            </a>
                            <ul class="list-unstyled">
                                <li><a href="{{ url('admin/pfu/datasurat/suratdibuat') }}">Surat Dibuat</a></li>
                                <li><a href="{{ url('admin/pfu/datasurat/arsipsurat') }}">Arsip Surat</a></li>
                                <li><a href="{{ url('admin/pfu/datasurat/suratditolak') }}">Surat Ditolak</a></li>
                            </ul>
                        </i>
                    </ul>
                </div>
