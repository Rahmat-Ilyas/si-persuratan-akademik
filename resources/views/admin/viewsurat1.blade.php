					...
					<div class="row">
						...
						<div class="col-md-6" style="padding-left: 50px;">
							...
							<div style="width: 150px; height: 100px; margin-top: -110px; margin-left: -80px;">
								@php
								$img = $paraf->where('surat_id', $dta->id)->first();
								@endphp
								<img src="{{ asset('storage/paraf/'.$img->file_paraf) }}" alt="op" id="set_ttd">
							</div>
						</div>
					</div>
					@elseif($proses == 5 && $dta->proses >= 5)
					<div class="row">
						<div class="col-md-6"></div>
						<div class="col-md-6" style="padding-left: 50px;">
							<p>Wassalama</p>
							...
							<div style="width: 150px; height: 100px; margin-top: -110px; margin-left: -80px;">
								@php
								$img_paraf = $paraf->where('surat_id', $dta->id)->first();
								@endphp
							...
							<div style="width: 200px; height: 140px; margin-top: -150px; margin-left: -10px;">
								@php
								$img_ttd = $tandatgn->where('surat_id', $dta->id)->first();
								@endphp
				...
				<div class="container p-20" style="border: 1px solid #ccc;">
					...
					<div class="row">
						...
						<div class="col-md-12" style="text-align: center;">
							...
							<b>Nomor: {{ $dta->no_surat }}/Un.06/FST/PP.{{ date('d/m/y', strtotime($dta->tggl_surat)) }}</b><br>
						</div>
					</div>
					<div class="row">
						<div class="col-md-1"></div>
