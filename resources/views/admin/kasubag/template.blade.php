...
<head>
  ...
  <title>Kasubag - Sistem Informasi Persuratan FST-UINAM</title>
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            $notif = $get->where('status', 'Dalam Proses')->where('proses', 0)->get();
                            $count = count($notif);
                            @endphp
                            <a href="{{ url('admin/kasubag/permintaansurat') }}" class="waves-effect">
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect">
                                <i class="fa fa-files-o"> <span class="menu-arrow"></span></i><span>Riwayat</span>
                            </a>
                            <ul class="list-unstyled">
                                <li><a href="{{ url('admin/kasubag/riwayat/diterima') }}">Surat Diterima</a></li>
                                <li><a href="{{ url('admin/kasubag/riwayat/ditolak') }}">Surat Ditolak</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
