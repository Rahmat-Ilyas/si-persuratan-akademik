...
<head>
  ...
  <title>Dekan - Sistem Informasi Persuratan FST-UINAM</title>
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            $notif = $get->where('proses', 4)->get();
                            $count = count($notif);
                            @endphp
                            <a href="{{ url('admin/dekan/permintaan') }}" class="waves-effect">
                        ...
                        <li class="has_sub">
                            <a href="{{ url('admin/dekan/suratdittd') }}" class="waves-effect">
                                <i class="fa fa-files-o"></i><span>Surat di Tanda Tangani</span>
                            </a>
                        </i>
                    </ul>
                </div>
