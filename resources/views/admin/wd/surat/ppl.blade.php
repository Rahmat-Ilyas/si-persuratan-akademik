				...
				<div class="row">
					<div class="col-sm-12">
						<div class="row">
							...
							<div class="col-lg-10"> 
								<form action="{{ url('/admin/wd/paraf/store') }}" method="POST">
									{{ csrf_field() }}
									@php
												...
												<div class="container text-center" style="margin-top: 40px;">
													<div id="signature-padi" class="m-signature-pad">
														<div class="m-signature-pad--body">
															<canvas style="width: 150px; height: 100px; border:1.5px dashed #ccc;"></canvas>
															<div style="margin-top: -65px;">
																<span style="color: #ccc;"><i>PARAF DISINI</i></span>
															</div>
															<div class="m-signature-pad--footer" style="margin-top: 50px;">
...
<script>
	jQuery(document).ready(function($) {
		$("#save").click(function(){
			$('#paraf').val(signaturePad.toDataURL());
