...
<head>
  ...
  <title>Kabag - Sistem Informasi Persuratan FST-UINAM</title>
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li class="has_sub">
                            ...
                            $notif = $get->where('proses', 1)->get();
                            $count = count($notif);
                            @endphp
                            <a href="{{ url('admin/kabag/permintaan') }}" class="waves-effect">
                        ...
                        <li class="has_sub">
                            <a href="{{ url('admin/kabag/riwayatverif') }}" class="waves-effect">
                                <i class="fa fa-files-o"></i><span>Surat di Verifikasi</span>
                            </a>
                        </i>
                    </ul>
                </div>
